...
food = ['삼겹살', '초밥', '회', '스테이크', '오겹살', '후라이드 치킨', '돼지갈비', '라면',
        '김치찌개', '육회', '등갈비 김치찜', '떡볶이', '곱창', '샤브샤브', '감자탕', '양념치킨',
        '돼지국밥', '소갈비', '대게찜', '항정살', '김치볶음밥', '킹크랩 찜', '부대찌개', '보쌈',
        '막창', '간장게장', '닭발', '훈제삼겹살', '된장찌개', '제육볶음', '바베큐 폭립', '불닭볶음면',
        '소고기타다끼', '햄버거', '뼈다귀 해장국', '순대국밥', '닭갈비', '랍스터 버터구이', '닭강정', '수육 국밥',
        '차돌박이', '갈매기살', '소갈비찜', '훈제연어 덮밥', '피자', '찜닭', '양갈비', '양꼬치',
        '갈비탕', '장어 구이', '돈까스', '해물칼국수', '닭도리탕', '짜파게티', '짜장면', '닭꼬치',
        '양념게장', '족발', '간장계란밥', '조개구이', '물냉면', '소고기미역국', '콘치즈', '설렁탕',
        '연어장', '치즈볼', '로스트 비프', '불족발', '버팔로윙', '훠궈', '탕수육', '돼지갈비찜',
        '산낙지', '순두부찌개', '로제파스타', '비빔밥', '크림소스 파스타', '쌀국수', '가브리살', '카레 돈까스 덮밥',
        '훈제치킨', '돈코츠라멘', '잔치국수', '우동', '짬뽕', '아구찜', '꽃게찜', '육개장',
        '떡국', '오일 파스타', '물회', '해물찜', '푸딩', '치킨마요덮밥', '깐쇼새우', '누룽지 백숙',
        '김밥', '회덮밥', '소떡소떡', '치킨 데리야끼', '소머리국밥', '장어덮밥', '탄두리치킨', '삼계탕',
        '곰탕', '타코야끼', '연어스테이크', '꿔바로우', '우렁쌈밥', '도너츠', '쭈꾸미 볶음', '계란식빵',
        '고구마 맛탕', '물떡', '계란찜', '수제비', '돼지껍데기', '어묵', '규동', '동파육',
        '제주 고기국수', '비빔냉면', '콩나물 해장국', '떡갈비', '토마토 스파게티', '기름 떡볶이', '함박스테이크', '대하소금구이',
        '오므라이스', '두부김치', '찐만두', '군만두', '불고기', '알밥', '메밀국수', '낙지볶음',
        '물만두', '꼼장어', '막국수', '참치 마요네즈 덮밥', '열무 국수', '오리주물럭', '토스트', '소고기무국',
        '감바스', '닭한마리', '오돌뼈', '보리굴비', '크림새우', '대구 내장탕', '텐동', '오리로스',
        '치즈 계란말이', '비빔국수', '만두전골', '쫄면', '묵사발', '깐풍기', '해신탕', '인도커리 + 난',
        '매운탕', '갈치구이', '야끼소바', '베이징덕', '가츠동', '참치 타다끼', '전복죽', '갈치조림',
        '충무김밥', '문어 숙회', '치즈 퐁듀', '시오라멘', '소세지야채볶음', '스키야키', '도가니탕', '케밥',
        '청국장', '시래기국', '굴', '장조림', '핫도그', '오코노미야끼', '추어탕', '훈제오리',
        '콩국수', '빠에야', '똠양꿍', '잡채밥', '고등어조림', '선지 해장국', '애플 파이', '홍어삼합',
        '샌드위치', '오이냉국', '꼬막무침', '전어구이', '마파두부 덮밥', '궁중떡볶이', '탄탄멘', '필라프',
        '맥 앤 치즈', '분짜', '버터오징어구이', '오징어 볶음', '연포탕', '과메기', '중식볶음밥', '모듬전',
        '초계국수', '콩나물밥', '골뱅이 무침', '오야코동', '타코', '닭똥집', '편육', '버섯전골',
        '전복장', '고추잡채', '해물누룽지탕', '수제 소세지', '미소라멘', '샐러드', '어죽', '낫토',
        '오차즈케', '냉이국', '오징어 무국', '매쉬드 포테이토', '미트볼', '바지락술찜', '팟타이', '단팥죽',
        '베이컨말이', '리조또', '코다리찜', '약밥', '두부전골', '안동국시', '매생이국', '상추튀김',
        '너비아니', '비프스튜', '빈대떡', '기스면', '유산슬', '크림스튜', '해파리냉채', '울면',
        '양장피', '난자완스', '푸아그라', '유린기', '피쉬 앤 칩스', '버섯들깨탕', '라조기', 'NULL']

food_eng = [
    "pork_belly", "sushi", "sashimi", "steak", "skinon_pork_belly", "fried_chicken", "pork_ribs", "ramen",
    "kimchi_stew", "beef_tartare", "braised_pork_galbi_and_kimchi", "tteokbokki", "beef_intestines",
    "shabu_shabu", "gamjatang", "seasoned_spicy_chicken", "pork_and_ricesoup", "grilled_galbi",
    "steamed_snow_crab", "grilled_pork_neck", "kimchi_fried_rice", "steamed_kingcrab", "budaejjigae",
    "bossam", "makchang", "ganjang_gejang", "chicken_foot", "smoked_pork_belly",
    "stir_fried_spicy_pork", "barbecue_pork_ribs", "buldak_stirfried_noodles", "beef_tadaki",
    "hamburger", "pork_backbone_hangover_soup", "sundae_and_rice_soup", "spicy_stir_fried_chicken",
    "grilled_lobster_butter", "dakgangjeong"
]
